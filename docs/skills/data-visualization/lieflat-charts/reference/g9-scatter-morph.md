...
<iframe src="/skills/data-visualization/lieflat-charts/assets/g9-scatter-morph.html"
        ...
        loading="lazy" title="G9 散点变形图：同一份数据，三种视角"></iframe>
...
> 模板来源：Lieflat Charts `G9 Scatter Morph`，真实骨架取自 [`templates/glance-gallery.html`](https://github.com/larashero3-dotcom/lieflat-charts/blob/e5b369de1d0d32637093ee62d60bd556cf2c1af4/templates/glance-gallery.html) 的 “One dataset, three views” 卡片与对应渲染块。

??? abstract "`g9-scatter-morph.html` —— 自包含单页源码"

    ```html
    --8<-- "skills/data-visualization/lieflat-charts/assets/g9-scatter-morph.html"
    ```
