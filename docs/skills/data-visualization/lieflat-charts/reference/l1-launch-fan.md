...
<iframe src="/skills/data-visualization/lieflat-charts/assets/l1-launch-fan.html"
        ...
        loading="lazy" title="L1 上线扇形图：十二项功能，依次展开成扇"></iframe>
...
> 模板来源：Lieflat Charts `L1 Launch Fan`，真实骨架取自 [`templates/lupi-gallery.html`](https://github.com/larashero3-dotcom/lieflat-charts/blob/e5b369de1d0d32637093ee62d60bd556cf2c1af4/templates/lupi-gallery.html) 的 “Twelve features, fanned out” 卡片与对应渲染块。

??? abstract "`l1-launch-fan.html` —— 自包含单页源码"

    ```html
    --8<-- "skills/data-visualization/lieflat-charts/assets/l1-launch-fan.html"
    ```
